...
class InputRecordField(CWLRecordField):
    ...
    def __hash__(self) -> int:
        return hash((self.doc, self.name, self.type, self.inputBinding, self.label))
...
class InputEnumSchema(EnumSchema, InputSchema):
    ...
    def __hash__(self) -> int:
        return hash((self.name, self.symbols, self.type, self.label, self.inputBinding))
...
class OutputRecordField(CWLRecordField):
    ...
    def __hash__(self) -> int:
        return hash((self.doc, self.name, self.type, self.outputBinding))
...
class OutputEnumSchema(EnumSchema, OutputSchema):
    ...
    def __hash__(self) -> int:
        return hash(
            (self.name, self.symbols, self.type, self.label, self.outputBinding)
        )
