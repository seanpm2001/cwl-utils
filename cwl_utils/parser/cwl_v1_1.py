        ...
        for k in _doc.keys():
            if k not in cls.attrs:
                if ":" in k:
                    ...
                    _errors__.append(
                        ValidationException(
                            "invalid field `{}`, expected one of: `id`, `label`, `doc`, `inputs`, `outputs`, `requirements`, `hints`, `cwlVersion`, `class`, `baseCommand`, `arguments`, `stdin`, `stderr`, `stdout`, `successCodes`, `temporaryFailCodes`, `permanentFailCodes`".format(
                                k
                            ),
                            SourceLine(_doc, k, str),
                        )
        ...
        for k in _doc.keys():
            if k not in cls.attrs:
                if ":" in k:
                    ...
                    _errors__.append(
                        ValidationException(
                            "invalid field `{}`, expected one of: `id`, `label`, `doc`, `inputs`, `outputs`, `requirements`, `hints`, `cwlVersion`, `class`, `expression`".format(
                                k
                            ),
                            SourceLine(_doc, k, str),
                        )
        ...
        for k in _doc.keys():
            if k not in cls.attrs:
                if ":" in k:
                    ...
                    _errors__.append(
                        ValidationException(
                            "invalid field `{}`, expected one of: `label`, `secondaryFiles`, `streamable`, `doc`, `id`, `format`, `outputSource`, `linkMerge`, `type`".format(
                                k
                            ),
                            SourceLine(_doc, k, str),
                        )
        ...
        for k in _doc.keys():
            if k not in cls.attrs:
                if ":" in k:
                    ...
                    _errors__.append(
                        ValidationException(
                            "invalid field `{}`, expected one of: `id`, `source`, `linkMerge`, `loadContents`, `loadListing`, `label`, `default`, `valueFrom`".format(
                                k
                            ),
                            SourceLine(_doc, k, str),
                        )
        ...
        for k in _doc.keys():
            if k not in cls.attrs:
                if ":" in k:
                    ...
                    _errors__.append(
                        ValidationException(
                            "invalid field `{}`, expected one of: `id`, `label`, `doc`, `in`, `out`, `requirements`, `hints`, `run`, `scatter`, `scatterMethod`".format(
                                k
                            ),
                            SourceLine(_doc, k, str),
                        )
        ...
        for k in _doc.keys():
            if k not in cls.attrs:
                if ":" in k:
                    ...
                    _errors__.append(
                        ValidationException(
                            "invalid field `{}`, expected one of: `id`, `label`, `doc`, `inputs`, `outputs`, `requirements`, `hints`, `cwlVersion`, `class`, `steps`".format(
                                k
                            ),
                            SourceLine(_doc, k, str),
                        )
...
array_of_union_of_CommandInputParameterLoader_or_WorkflowInputParameterLoader = (
    _ArrayLoader(
        union_of_CommandInputParameterLoader_or_WorkflowInputParameterLoader, True
    )
)
